CREATE DATABASE "controladorDB" WITH ENCODING='UTF8' CONNECTION LIMIT=-1;
...
insert into usuario (id, cadastro, celular, confirmado, descricao, email, senha, tipo, validade) 
values (1, now(), '(62) 9129-9791', true, 'Elber', 'elber_gyn@hotmail.com', 
'BA3253876AED6BC22D4A6FF53D8406C6AD864195ED144AB5C87621B6C233B548BAEAE6956DF346EC8C17F5EA10F35EE3CBC514797ED7DDD3145464E2A0BAB413', 
'ADM', '2050-01-01');
select setval('usuario_id_seq', 1);

INSERT into parametros_sistema values (1, 'cruze', 1);
select setval('parametros_sistema_id_seq', 1);

insert into ctr_categoria_despesa values (1, 'Alimentação', 1),(2, 'Diversos', 1),(3, 'Lazer', 1), (4, 'Mensal', 1);
select setval('ctr_categoria_despesa_id_seq', 4);

insert into pdv_tipo_recebimento values (1, 'Dinheiro', 1);
select setval('pdv_tipo_recebimento_id_seq', 1);